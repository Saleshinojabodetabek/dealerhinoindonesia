...
<html lang="id">
  <head>
    ...
    <meta name="description" content="Hino 300 Series (Dutro) – Truk ringan tangguh untuk bisnis. Dapatkan harga terbaru, spesifikasi lengkap, promo 2025, serta pilihan kredit dan cicilan ringan. Hubungi Nathan Hino untuk penawaran terbaik: 0859-7528-7684." />
    <meta
      name="keywords"
    ...
    <!-- Open Graph -->
    <meta property="og:title" content="Hino Dutro 300 Series | Harga & Spesifikasi Terbaru 2025" />
    <meta property="og:description" content="Lihat daftar lengkap Hino Dutro 300 Series — performa kuat, hemat BBM, dan cocok untuk kebutuhan bisnis ringan–menengah." />
    <meta property="og:image" content="https://dealerhinoindonesia.com/images/hino300.jpg" />
    <meta property="og:url" content="https://dealerhinoindonesia.com/hino300.php" />
    ...
    <meta
      name="twitter:title"
      content="Dealer Resmi Hino Jakarta | Harga & Promo Truk Hino Terbaru 2025"
    />
    <meta
  ...
  <body>
    ...
    <script>
      ...
      function loadProduk() {
        fetch(
          `admin/api/get_product.php?series_id=${seriesId}&varian=${currentVarian}&search=${encodeURIComponent(currentSearch)}`
        )
          .then(res => res.json())
          .then(data => {
            let html = "";
      ...
      document.addEventListener("DOMContentLoaded", () => {
        ...
        document.querySelectorAll(".tabs .tab").forEach(tab => {
          tab.addEventListener("click", e => {
            ...
            // Set varian dan load ulang produk
