  ...
  <body>
    ...
    <div class="kategori-section">
      ...
      <div class="produk-controls">
        <div class="tabs">
          <a href="hino300.php?varian=ALL" class="tab">ALL</a>
          <a href="hino300.php?varian=CARGO" class="tab">CARGO</a>
          <a href="hino300.php?varian=DUMP" class="tab">DUMP</a>
          <a href="hino300.php?varian=MIXER" class="tab">MIXER</a>
        </div>
